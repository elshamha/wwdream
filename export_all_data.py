...
def export_all_data():
    ...
    # Export Users with their groups
    for user in User.objects.all():
        ...
        print(f"Exporting user: {user.username} with groups: {user_data['groups']}")
    ...
    with open('complete_data_export.json', 'w', encoding='utf-8') as f:
    ...
    print("Data saved to complete_data_export.json")
